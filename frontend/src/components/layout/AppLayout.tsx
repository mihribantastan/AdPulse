...
export function AppLayout({ title, subtitle, children }: { title: string; subtitle?: string; children: ReactNode; }) {
  return (
    <div
      className="min-h-screen text-ink-100 relative"
    ...
    >
      ...
      />
      <div
        className="pointer-events-none fixed -bottom-48 -right-32 w-[36rem] h-[36rem] rounded-full opacity-[0.12] blur-[130px] z-0"
        style={{ background: 'radial-gradient(circle, #33C2E8 0%, transparent 70%)' }}
      />
