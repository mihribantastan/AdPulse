    ...
    <div className="min-h-screen relative flex bg-ink-950 text-ink-100 font-sans overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6 z-10">
        <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-xl shadow-2xl shadow-black/40 p-8">
          ...
          <h1 className="font-display text-2xl text-ink-100">Giriş Yap</h1>
          <p className="text-sm text-ink-400 mt-2 mb-7">Kampanyalarını yönetmeye devam et.</p>
          ...
          <p className="text-center text-sm text-ink-400 mt-6">
            Hesabın yok mu? <Link to="/signup" className="text-accent-400 font-medium hover:underline">Kayıt ol</Link>
          </p>
        </div>
      </div>
    </div>
